...
**Final verdict:** FAIL
**Run ID:** 01KZ7CW5H6Z6EF2QSDT4SJQ8RK
...
- acs-durable (-tags acs) FAILED 5 check(s) — CI acs-durable gate would FAIL (flag-registry / flag-ceiling / skills-drift). Offenders: --- FAIL: TestEveryGateShapedFileIsProtectedSurface (0.07s); pred
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1309
