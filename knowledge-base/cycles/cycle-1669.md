...
**Final verdict:** FAIL
**Run ID:** 01M2E8QAD67DX6ZM2E97ED7B62
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 1m27s |  |
| triage | plan | FAIL | 1m54s |  |

## Timing

**Total:** 3m21s across 2 phases (0 retried) · **Longest:** triage 1m54s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1669
