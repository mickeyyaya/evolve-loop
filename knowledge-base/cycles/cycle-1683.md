...
**Final verdict:** FAIL
**Run ID:** 01M2GF47PKNEQ1VWR30ADM7R4E
**Committed:** `integration-tier-tmux-live-dispatch-exclusion`
...
| triage | plan | FAIL | 50s |  |

## Timing

**Total:** 2m39s across 2 phases (0 retried) · **Longest:** scout 1m49s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1683
