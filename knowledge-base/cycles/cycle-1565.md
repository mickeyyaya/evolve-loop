...
**Final verdict:** FAIL
**Run ID:** 01M0WDJNGVG4Q6ZYWH7YS432AK
...
**Fingerprint:** `audit|gate-block|813c5fe5c6b5` · **Class:** gate-block

- EGPS: red_count=1 [StaleItemIsRetiredFromTheInboxRoot] (cycle ships only when red_count==0)


## Carryover

- **address-audit-findings** (high): resolve the audit findings that failed cycle 1565
