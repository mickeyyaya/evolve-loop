...
**Final verdict:** FAIL
**Run ID:** 01M2DQMZS6JBFH1D018BCVEC16
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 2m21s |  |
| triage | plan | FAIL | 1m53s |  |

## Timing

**Total:** 4m15s across 2 phases (0 retried) · **Longest:** scout 2m21s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1658
