...
**Final verdict:** FAIL
**Run ID:** 01M2E8QACNBQ7KGRD3NAWVC9WE
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 3m17s |  |
| triage | plan | FAIL | 2m18s |  |

## Timing

**Total:** 5m35s across 2 phases (0 retried) · **Longest:** scout 3m17s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1668
