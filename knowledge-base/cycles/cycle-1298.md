...
**Final verdict:** FAIL
**Run ID:** 01KZ6VZYRREJ469DPHB6A2F4E0
...
- acs-durable (-tags acs) FAILED 5 check(s) — CI acs-durable gate would FAIL (flag-registry / flag-ceiling / skills-drift). Offenders: --- FAIL: TestEveryGateShapedFileIsProtectedSurface (0.04s); pred
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1298
