...
**Final verdict:** FAIL
**Run ID:** 01M2E932KJ6Q3Y40KN00R024V9
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 2m41s |  |
| triage | plan | FAIL | 17m9s |  |

## Timing

**Total:** 19m50s across 2 phases (0 retried) · **Longest:** triage 17m9s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1672
