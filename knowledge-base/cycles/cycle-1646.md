...
**Final verdict:** FAIL
**Run ID:** 01M2CWSN8JN53NF68BNA990T8S
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 3m5s |  |
| triage | plan | FAIL | 2m35s |  |

## Timing

**Total:** 5m40s across 2 phases (0 retried) · **Longest:** scout 3m5s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1646
