...
**Final verdict:** FAIL
**Run ID:** 01M2BAZZVHK52Q3KKD1SNPX95A
**Committed:** `phase-stub-shape-rule-at-ship-staging`
...
| triage | plan | FAIL | 2m8s |  |

## Timing

**Total:** 4m31s across 2 phases (0 retried) · **Longest:** scout 2m24s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1636
