...
**Final verdict:** FAIL
**Run ID:** 01M2E0HSKRTYZD5BGF7RM32Q9G
...
|-------|-----------|---------|----------|--------------|
| scout | plan | PASS | 3m37s |  |
| triage | plan | FAIL | 2m14s |  |

## Timing

**Total:** 5m51s across 2 phases (0 retried) · **Longest:** scout 3m37s
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1665
