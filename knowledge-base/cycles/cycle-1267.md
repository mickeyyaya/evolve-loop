...
**Final verdict:** FAIL
**Run ID:** 01KZ4ZH3BXXQ0NR0526H06M2TJ
...
**Fingerprint:** `audit|infra-error|b7f1e64393b3` · **Class:** infra-error
...
- **address-audit-findings** (high): resolve the audit findings that failed cycle 1267
