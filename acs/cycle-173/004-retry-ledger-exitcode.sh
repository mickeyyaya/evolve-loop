#!/usr/bin/env bash
# AC-ID: cycle-173-004-retry-ledger-exitcode
# AC-source: scout-report.md T1 transient-bridge-retry — phase_retry ledger entry carries the real exit code (80), not hardcoded 81
#
...
PKG="./internal/core/..."
T="TestTransientRetry_LedgerEntry"
