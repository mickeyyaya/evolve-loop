#!/usr/bin/env bash
# AC-ID: cycle-173-002-transient-retry-recovers
# AC-source: scout-report.md T1 transient-bridge-retry — transient exit 80 on attempt 1 retried, cycle recovers (GAP 1)
#
...
PKG="./internal/core/..."
T="TestOrchestrator_RetryOnTransientExit"
