#!/usr/bin/env bash
# AC-ID: cycle-173-006-transient-exhausted-failurediag
# AC-source: scout-report.md T1 transient-bridge-retry — all-transient exhaustion aborts + writes failure-diag
#
...
PKG="./internal/core/..."
T="TestTransientRetry_Exhausted_WritesFailureDiag"
