#!/usr/bin/env bash
# AC-ID: cycle-173-003-noncanonical-verdict-retry
# AC-source: scout-report.md T1 transient-bridge-retry — non-canonical verdict retried inside the loop (GAP 5)
#
...
PKG="./internal/core/..."
T="TestOrchestrator_NonCanonicalVerdictRetry"
