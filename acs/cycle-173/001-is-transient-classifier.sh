#!/usr/bin/env bash
# AC-ID: cycle-173-001-is-transient-classifier
# AC-source: scout-report.md T1 transient-bridge-retry — isTransientBridgeError classifies 80/85/86 true; 81/2/127/nil false
#
