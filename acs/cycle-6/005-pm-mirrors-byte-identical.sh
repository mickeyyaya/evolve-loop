#!/usr/bin/env bash
# AC-ID:         cycle-6-005
# Description:   PM agents/evolve-<name>.md mirrors are byte-identical to .evolve/phases/<name>/agent.md (diff exits 0 for all 3)
# Evidence:      agents/evolve-{risk-register,scope-baseline,dependency-map}.md vs .evolve/phases/*/agent.md
# Author:        tdd-engineer
# Created:       2026-06-06T00:00:00Z
# Acceptance-of: scout-report.md AC#5 — wave-pm-tdd-and-phases
...
fail=0
for name in risk-register scope-baseline dependency-map; do
...
echo "GREEN: all 3 PM mirrors byte-identical to phase-dir agent.md" >&2
exit 0
