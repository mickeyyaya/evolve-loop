...
FIXTURE_CAP="$TMP_DIR/codex-fixture.capabilities.json"
printf '{"adapter":"codex","version":2,"supports":{"non_interactive_prompt":true}}' > "$FIXTURE_CAP"
...
EVOLVE_TESTING=1 \
  ...
  EVOLVE_CODEX_CAP_FILE="$FIXTURE_CAP" \
