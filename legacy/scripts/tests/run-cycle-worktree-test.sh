...
#
# Usage: bash legacy/scripts/run-cycle-worktree-test.sh
...
if grep -q "v8.36.0: prune stale worktree admin entries" "$REPO_ROOT/legacy/scripts/dispatch/run-cycle.sh"; then
