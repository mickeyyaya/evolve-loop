#!/usr/bin/env bash
#
# aggregator-test.sh — Unit tests for legacy/scripts/dispatch/aggregator.sh.
#
...
SCRIPT="$REPO_ROOT/legacy/scripts/dispatch/aggregator.sh"
...
header "Test 1: legacy/scripts/dispatch/aggregator.sh exists and is executable"
