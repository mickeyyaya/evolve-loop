...
#
# Usage:
#   bash legacy/scripts/release/changelog-gen.sh <from-ref> <to-ref> <target-version> [--dry-run]
#
...
entry+="_Generated by \`legacy/scripts/release/changelog-gen.sh\` from commits ${FROM_REF}..${TO_REF}._"$'\n\n'
