...
| `EVOLVE_CONDITIONAL_MANDATORY` | `tdd:cycle_size!=trivial&&deliverable_kind!=document` | `phase:expr` conditional-mandatory rule; clauses joined by `&&` are AND-ed (ADR-0099). | — |
