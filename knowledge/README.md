...
| **[reference/](reference/)** | Lookup tables: the [env-var reference](reference/env-vars.md), the [CLI capability matrix](reference/cli-capability-matrix.md), and the [memory subsystem](reference/memory-instincts-and-genes.md) (instincts, genes, learning config). |
