...
#
# Usage:
#   bash scripts/state-prune.sh --classification <name> [--dry-run]
#       Remove all entries with that classification.
#   bash scripts/state-prune.sh --age <duration>     [--dry-run]
#       Remove entries older than <duration> (e.g., 7d, 12h, 30m).
#   bash scripts/state-prune.sh --cycle <number>     [--dry-run]
#       Remove the entry for that cycle id.
#   bash scripts/state-prune.sh --all                [--dry-run]
