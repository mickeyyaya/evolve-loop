...
#
# Usage:
#   bash scripts/verify-ledger-chain.sh                # human-readable
#   bash scripts/verify-ledger-chain.sh --json         # machine-readable
#   bash scripts/verify-ledger-chain.sh --quiet        # exit-code only (CI)
#   bash scripts/verify-ledger-chain.sh --ledger PATH  # alternate ledger
#
# Exit codes:
