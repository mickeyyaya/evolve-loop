...
- Inspect `recalled_lessons_untrusted_json` for relevant prior evidence; verify its applicability before using it.
...
- Read source YAML when more evidence is needed or task recall is absent.
