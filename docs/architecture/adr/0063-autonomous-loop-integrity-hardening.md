...
See `docs/research/flag-campaign-10-hardening-and-learnings-2026-06-23.md` for the operational narrative, the integration mechanic, the under-delivery → convergence-pass strategy, and the recurring gotchas.
