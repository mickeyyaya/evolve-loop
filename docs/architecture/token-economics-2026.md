...
| **P2** | **v9.0.4 / v10.10.0 — builder turn-budget guidance** (checkpoint at turn 15, hard-exit at turn 20) | **~$0.10–$0.20/cycle** (saves 3–5 turns × $0.034/turn at current baseline) | Medium | **Shipped cycle 70** — `builder.json:turn_budget_guidance`, `agents/evolve-builder.md` §"Budget Checkpoint Protocol" | This doc §"Per-phase"; `docs/operations/incidents/turn-overrun-c69.md` |
