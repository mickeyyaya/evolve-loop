...
| P4 | Auditor anchor mode for intent.md (`intent.md:acceptance_criteria`) | ~$0.03–$0.06/cycle (7.3 KB × 22 turns × Opus cache-read rate) | **Tiny** (1 JSON edit) | **Implementing (cycle 69)** — see `knowledge-base/research/anchored-context-injection-2026.md` | D1 above |
