...
| `legacy/scripts/utility/code-review-simplify.sh` | Pipeline layer engine — 6 deterministic checks | 200 |
| `legacy/scripts/verification/complexity-check.sh` | Per-function cognitive complexity scorer | 110 |
...
### Pipeline Script (`legacy/scripts/utility/code-review-simplify.sh`)

```bash
# Usage
bash legacy/scripts/utility/code-review-simplify.sh [GIT_REF] [--json]
...
| Cognitive complexity | > 15/function | `maintainability` | `legacy/scripts/verification/complexity-check.sh` |
...
### Complexity Check Script (`legacy/scripts/verification/complexity-check.sh`)

```bash
# Usage
bash legacy/scripts/verification/complexity-check.sh <file> [--threshold N]
```
...
| `legacy/scripts/utility/code-review-simplify.sh` | Pipeline layer implementation |
| `legacy/scripts/verification/complexity-check.sh` | Complexity scoring engine |
