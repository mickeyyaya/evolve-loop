...
See [phase6-learn.md](../../skills/loop/phase6-learn.md) § Instinct Graduation for the canonical executable specification.
...
See [phase6-learn.md](../../skills/loop/phase6-learn.md) § Instinct Graduation for the full specification.
