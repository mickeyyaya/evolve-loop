#!/usr/bin/env bash
#
# evolve-loop-dispatch-test.sh — Unit tests for archive/legacy/scripts/dispatch/evolve-loop-dispatch.sh.
#
...
DISPATCH="$REPO_ROOT/archive/legacy/scripts/dispatch/evolve-loop-dispatch.sh"
