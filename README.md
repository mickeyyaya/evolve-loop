...
**Current (v20.4)** · A self-evolving development pipeline that improves your codebase while you sleep — with structural anti-gaming so you can trust the result.
...
| v20.3 | Jun 23 | TBD — fill in via release-pipeline.sh + changelog-gen.sh |
| v20.4 | Jun 24 | TBD — fill in via release-pipeline.sh + changelog-gen.sh |
