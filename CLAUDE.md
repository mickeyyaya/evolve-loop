...
- Routing: `EVOLVE_DYNAMIC_ROUTING=off` default; integrity floor `ship ⇒ build ∧ audit ∧ (tdd unless trivial)`; policy pins in `.evolve/policy.json` (`EVOLVE_POLICY_BYPASS` off). Swarm: `EVOLVE_SWARM_STAGE=shadow`.
