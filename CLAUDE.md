...
If the user is in bypass permissions mode, YOU MUST CONTINUE PROCEEDING TO THE END WITHOUT ASKING THE USER PERMISSION. Never stop until the task is completed.
