...
- `audit-regression` — runs `legacy/scripts/utility/run-all-regression-tests.sh`
...
```bash
bash legacy/scripts/dispatch/subagent-run.sh dispatch-parallel auditor <cycle> <workspace>
```
